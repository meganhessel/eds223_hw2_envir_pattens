...
# EDS 223: Exploring Patterns of Environmental Justice
...
tm_shape(ineq, is.main = TRUE) +
  tm_polygons(
    fill = 'grade',
    title = "HOLC Grade",
    palette = c("#6CCC4B", "#67C9D5", "#F5F52F", "#D9838D") # Tried to make colors consistent for the entire project: A = good = cooler colors; D = bad = reds) 
  ) +
  tm_basemap("Esri.OceanBasemap") +
  tm_title("Home Owners Loan Corporation (HOLC) Redlining") +
  tm_scalebar(position = c("right", "top")) + 
  tm_compass(position = c("left", "bottom")) + 
  tm_credits("Grade A: 'best' areas (safe, most desirable)\nGrade B: 'Still Desirable' areas\nGrade C: 'Definitely Declining' areas\nGrade D: 'Hazardous' areas", size = 0.5)

```

#### Grade Meanings 

-   Grade A: safe, most desirable, 'best' areas

-   Grade B: 'Still Desirable' areas

-   Grade C: 'Definitely Declining' areas

-   Grade D: 'Hazardous' areas
...
ggplot(sum_table, aes(x = "", y = grade_perc, fill = grade)) +
  ...
  geom_text(aes(label = grade_perc),
            ...
            size = 3) +
  coord_polar(theta = "y") +
  scale_fill_manual(values = c("#6CCC4B", "#65C6D1", "#F0E06E", "#D9838D")) +
  theme_minimal() +
  labs(y = "Percentages of Census Block Groups per HOLC Grade\nin Los Angeles, CA", 
       fill = "HOLC Grades", 
       caption = "Grade A: 'Best' areas\nGrade B: 'Still Desirable' areas\nGrade C: 'Definitely Declining' areas\nGrade D: 'Hazardous' areas") + 
...
CA_holc <- tm_shape(CA_LA) + # Wanted to outline LA blocks for easy comparsion 
  ...
  tm_polygons(
    ...
    fill.scale = tm_scale(values = c("#6CCC4B", "#67C9D5", "#F5F52F", "#D9838D"))
    ) + 
tm_basemap("Esri.OceanBasemap") +
...
# Boxplot 
ggplot(sub_long, aes(x = grade, y = values, fill = grade)) + # Using pivoted df with ALL values  
  geom_boxplot(stat = "boxplot") +
  facet_wrap( ~ means) +
  scale_fill_manual(values = c("#6CCC4B", "#69D1DE", "#F0E06E", "#ED919B")) + 
  theme_grey() + 
  theme(panel.spacing = unit(1.5, "lines"), 
        plot.caption = element_text(size = 7)) + 
  labs(title = "Average Current Conditions within the HOLC Grades in Los Angeles, CA",
       x = "HOLC Grades",
       y = "Percentiles",
       fill = "HOLC Grades", 
       caption = "Grade A: 'Best' areas\nGrade B: 'Still Desirable' areas\nGrade C: 'Definitely Declining' areas\nGrade D: 'Hazardous' areas")
...
ggplot(summary_long, aes(y = values, x = grade, fill = grade)) + # Using pivoted df of avg of the values  
  ...
  scale_fill_manual(
    ...
    values = c("#6CCC4B", "#65C6D1", "#F0E06E", "#D9838D")) +
  labs(title = "Average Current Conditions within the HOLC Grades in Los Angeles, CA",
       x = "HOLC Grades",
       y = "Percentiles",
       fill = "HOLC Grades", 
...
ggplot(bird_by_grade, 
       aes(x = grade, 
           ...
           fill = grade)) + 
  geom_col(color = "black") + 
  labs(title = "Percent Bird Observations per HOLC Grade in Los Angeles, CA", 
       x = "HOLC Grade", 
       y = "Percentage of Bird Observations", 
       fill = "HOLC Grade", 
       caption = "Grade A: 'Best' areas\nGrade B: 'Still Desirable' areas\nGrade C: 'Definitely Declining' areas\nGrade D: 'Hazardous' areas") + 
  scale_fill_manual(values = c("#6CCC4B", "#67C9D5", "#F0E06E", "#D9838D"))
